...
user.name = 'Pete';
Відповідь
Так, об'єкт,  оголошений за допомогою const можна змінити, так як об'єкт це посилальний 
тип даних. Const зберігає посилання на об'єкт, а властивості цього об'єкта можна змінювати
